  ...
  const beforeAfterImages = [
    {
      ...
      title: "התקנת רשתות הרחקה - בניין משרדים"
    },
    {
      ...
      title: "מערכות הרחקת יונים - מרכז מסחרי"
    },
    {
      ...
      title: "פתרונות הרחקה - בניין מגורים"
    }
  ];
      ...
      <section className="relative min-h-[70vh] flex items-center justify-center bg-hero text-foreground overflow-hidden pt-header-offset lg:pt-header-offset-lg">
        ...
        >
          ...
          <p className="text-lg md:text-xl mb-8 max-w-2xl mr-auto leading-relaxed opacity-90">
            פתרונות יעילים והומניים להרחקת יונים ועופות מבניינים. מתמחים בהתקנת רשתות,
            דוקרנים ומערכות הרחקה מתקדמות בגובה.
          </p>
          <button
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold mb-8 text-right text-foreground">
              מה כולל שירות הרחקת מעופפים?
            </h2>
            
            <div className="space-y-6 text-foreground/90 leading-relaxed">
              <p className="text-lg">
                הרחקת עופות ממבנים היא בעיה נפוצה הדורשת פתרונות מקצועיים ויעילים.
                אנו מציעים מגוון רחב של פתרונות להרחקת יונים ועופות אחרים, כולם הומניים
                ובהתאם לתקנות הגנת בעלי החיים.
              </p>
              ...
              <div ref={serviceCardRef} style={serviceCardStyle} className="bg-card rounded-card p-8 border border-border">
                ...
                <ul className="space-y-4 text-foreground/90">
                  <li className="flex items-start gap-3">
                    ...
                    <span>התקנת רשתות הרחקה איכותיות ועמידות</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-primary text-xl">•</span>
                    <span>התקנת דוקרנים ומחסומים פיזיים</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-primary text-xl">•</span>
                    <span>מערכות הרחקה אלקטרוניות ואולטרה-סוניות</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-primary text-xl">•</span>
                    <span>סגירת נקודות כניסה וקינון</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-primary text-xl">•</span>
                    <span>ניקוי והסרת קינים קיימים</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-primary text-xl">•</span>
                    <span>חיטוי וטיפול במזיקים</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-primary text-xl">•</span>
                    <span>פתרונות מותאמים למבנים היסטוריים</span>
                  </li>
                </ul>
              </div>

              <p className="text-lg">
                כל הפתרונות שלנו הומניים ובטוחים לעופות ולסביבה. אנו מתמחים בעבודות בגובה
                ומציעים אחריות מלאה על כל ההתקנות.
              </p>
            </div>
          </div>
        </div>
