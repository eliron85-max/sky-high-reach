...
const Waterproofing = () => {
  ...
  const beforeAfterImages = [
    {
      ...
      title: "איטום גג בגובה - בניין מגורים"
    },
    {
      before: "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=800",
      after: "https://images.unsplash.com/photo-1487958449943-2429e8be8625?w=800",
      title: "איטום חזית - מבנה משרדים"
    },
    {
  ...
  const relatedProjects = [
    {
      id: 1,
      title: "איטום גג - מגדל משרדים רמת גן",
    ...
    {
      id: 2,
      title: "איטום חזית - פרויקט מגורים",
      category: "איטום בגובה",
    ...
    {
      id: 3,
      title: "איטום מרפסות - בניין יוקרה",
      category: "איטום בגובה",
      ...
      <section className="relative min-h-[70vh] flex items-center justify-center bg-hero text-foreground overflow-hidden">
        ...
        >
          ...
          <p className="text-lg md:text-xl mb-8 max-w-2xl mr-auto leading-relaxed opacity-90">
            פתרונות איטום מתקדמים לגגות, חזיתות ומרפסות בגובה. מומחים במניעת חדירות מים
            ובטיפול בבעיות איטום מורכבות במבנים רבי קומות.
          </p>
          <button
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold mb-8 text-right text-foreground">
              מה כולל שירות איטום בגובה?
            </h2>
            
            <div className="space-y-6 text-foreground/90 leading-relaxed">
              <p className="text-lg">
                איטום בגובה הוא תהליך קריטי למניעת חדירות מים ושמירה על שלמות המבנה.
                אנו משתמשים בחומרי איטום מתקדמים וטכניקות חבלים המאפשרות ביצוע עבודות איטום
                באיכות גבוהה בכל גובה ובכל תנאי שטח.
              </p>
              ...
              <div ref={serviceCardRef} style={serviceCardStyle} className="bg-card rounded-card p-8 border border-border">
                ...
                <ul className="space-y-4 text-foreground/90">
                  <li className="flex items-start gap-3">
                    ...
                    <span>איטום גגות שטוחים וגגות רעפים בגובה</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-primary text-xl">•</span>
                    <span>איטום חזיתות ומעטפת חיצונית</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-primary text-xl">•</span>
                    <span>איטום מרפסות וגלריות בגובה</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-primary text-xl">•</span>
                    <span>טיפול בנזילות ובעיות חדירת מים</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-primary text-xl">•</span>
                    <span>איטום חיבורים ומפרקי התפשטות</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-primary text-xl">•</span>
                    <span>איטום קירות מסך וחלונות פנורמיים</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-primary text-xl">•</span>
                    <span>בדיקות דליפות ואבחון מקור נזילות</span>
                  </li>
                </ul>
              </div>

              <p className="text-lg">
                כל עבודות האיטום מבוצעות בפיקוח הנדסי ועם אחריות מלאה. אנו משתמשים רק בחומרים
                איכותיים ומאושרים ומקפידים על עמידה בתקנים הישראליים והבינלאומיים.
              </p>
            </div>
          </div>
        </div>
