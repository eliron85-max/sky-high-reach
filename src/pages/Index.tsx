...
export default function Index() {
  ...
  return (
    <div className="min-h-screen bg-hero-dark">
      ...
      {/* ========== #1 HERO ========== */}
      <div className="h-screen w-full overflow-hidden relative" dir="rtl">
        <section className="w-full h-full overflow-hidden relative">
          ...
          {/* Hero content */}
          <div className="absolute inset-0 flex items-center justify-center px-4 sm:justify-start sm:px-12 md:px-16 lg:px-24">
