...
const HERO_IMAGE = "https://images.unsplash.com/photo-1486325212027-8081e485255e";
...
const SpecialProjects = () => {
  ...
  const beforeAfterImages = [
    {
      ...
      title: "התקנת שילוט בגובה - מגדל משרדים"
    },
    {
      before: "https://images.unsplash.com/photo-1460472178825-e5240623afd5?w=800",
      after: "https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?w=800",
      title: "עבודות מיוחדות - אנטנות ותשתיות"
    },
    {
      before: "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=800",
      after: "https://images.unsplash.com/photo-1590725121839-892b458a74fe?w=800",
      title: "פרויקט ייחודי - מבנה אדריכלי"
    }
  ];
  ...
  const relatedProjects = [
    ...
    {
      id: 2,
      title: "עבודות אנטנות - מגדל משרדים",
      category: "עבודות מיוחדות",
    ...
    {
      id: 3,
      title: "פרויקט אדריכלי - מבנה ייחודי",
      category: "עבודות מיוחדות",
      ...
      <section className="relative min-h-[70vh] flex items-center justify-center bg-hero text-foreground overflow-hidden">
        ...
        >
          ...
          <p className="text-lg md:text-xl mb-8 max-w-2xl mr-auto leading-relaxed opacity-90">
            פתרונות יצירתיים למשימות בלתי שגרתיות בגובה. מתמחים בפרויקטים מורכבים
            הדורשים מומחיות מיוחדת, ציוד ייחודי וחשיבה יצירתית.
          </p>
          <button
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold mb-8 text-right text-foreground">
              מה כוללות עבודות גובה מיוחדות?
            </h2>
            
            <div className="space-y-6 text-foreground/90 leading-relaxed">
              <p className="text-lg">
                עבודות גובה מיוחדות הן פרויקטים ייחודיים ומאתגרים הדורשים גישה יצירתית,
                ציוד מתקדם ומומחיות מיוחדת. אנו מתמחים בפתרון אתגרים מורכבים בגובה שאין
                להם פתרון סטנדרטי.
              </p>
              ...
              <div ref={serviceCardRef} style={serviceCardStyle} className="bg-card rounded-card p-8 border border-border">
                ...
                <ul className="space-y-4 text-foreground/90">
                  <li className="flex items-start gap-3">
                    ...
                    <span>התקנת שילוט ופרסום בגובה</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-primary text-xl">•</span>
                    <span>עבודות תשתיות תקשורת ואנטנות</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-primary text-xl">•</span>
                    <span>התקנת מערכות תאורה ותאורת חוץ בגובה</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-primary text-xl">•</span>
                    <span>ניקוי חלונות ומשטחי זכוכית במבנים גבוהים</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-primary text-xl">•</span>
                    <span>בדיקות והערכות מצב מבניות בגובה</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-primary text-xl">•</span>
                    <span>עבודות צילום ותיעוד אווירי</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-primary text-xl">•</span>
                    <span>פרויקטים אדריכליים ייחודיים</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-primary text-xl">•</span>
                    <span>עבודות חירום והצלה בגובה</span>
                  </li>
                </ul>
              </div>

              <p className="text-lg">
                כל פרויקט מקבל תכנון מיוחד ומותאם אישית. אנו עובדים בשיתוף פעולה עם
                אדריכלים, מהנדסים ויועצים מקצועיים כדי למצוא את הפתרון האופטימלי לכל אתגר.
              </p>
            </div>
          </div>
        </div>
