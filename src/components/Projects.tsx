...
import stoneCladdinHeight from "@/assets/stone-cladding-height.webp";
...
const Projects = () => {
  ...
  { id: 13, title: "עבודות חיפוי בגובה", category: "חיפוי ועיגון אבנים", location: "מרכז", images: [stoneCladdinHeight] }];
