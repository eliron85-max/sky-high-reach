          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <form onSubmit={handleSubmit} className={cn(card, "space-y-6")}>
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <Input id="fullName" value={formData.fullName} onChange={handleInputChange} className={cn(field, validationErrors.fullName && "border-red-500")} disabled={isSubmitting} required />
                  ...
                  <div>
                    ...
                    <Input id="company" value={formData.company} onChange={handleInputChange} className={field} disabled={isSubmitting} />
                  </div>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <Input id="phone" value={formData.phone} onChange={handleInputChange} className={cn(field, validationErrors.phone && "border-red-500")} disabled={isSubmitting} required />
                  ...
                  <div>
                    ...
                    <Input id="email" type="email" value={formData.email} onChange={handleInputChange} className={cn(field, validationErrors.email && "border-red-500")} disabled={isSubmitting} required dir="ltr" />
                ...
                <div>
                  ...
                  <Textarea id="message" value={formData.message} onChange={handleInputChange} className={cn(textarea, validationErrors.message && "border-red-500")} disabled={isSubmitting} rows={6} required />
            ...
            <div className="space-y-6">
              <div className={card}>
                ...
                <div className="gap-3 mt-4 flex-col flex items-start justify-end">
