...
backdrop-blur-xl supports-[backdrop-filter]:bg-black/5 bg-black/10
...
transition-transform duration-700 ${isVisible || mobileOpen ? "translate-y-0" : "-translate-y-full"}`}
    ...
    >
      ...
      <div className="hidden md:block relative z-20 bg-white/10 dark:bg-black/10 backdrop-blur-2xl border-b border-white/20 dark:border-[#c9a84c]/20">
        ...
        <div className="mx-auto max-w-7xl px-4 lg:px-6 h-[150px] grid grid-cols-[1fr_auto_1fr] items-center gap-8">
          <nav className="flex items-center gap-6 xl:gap-8 text-[16px] xl:text-[18px] font-semibold justify-self-end min-w-0">
            ...
            >
              ...
              >
                {t("nav.services")}
                <span className="text-[14px] text-white dark:text-[#c9a84c] opacity-80">▼</span>
              </button>
      ...
      <div className="hidden md:block relative z-10 bg-white/10 dark:bg-black/10 backdrop-blur-2xl border-t border-white/20 dark:border-[#c9a84c]/10">
