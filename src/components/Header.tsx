...
export default function Header() {
  ...
  return <header className={`fixed top-0 left-0 right-0 z-50 transition-opacity duration-1000 ${isVisible ? "opacity-100" : "opacity-0 pointer-events-none"} ${isVisible ? "lg:translate-y-0" : "lg:-translate-y-full"} lg:transition-all`} dir="rtl">
      ...
      {/* ================= MOBILE FIXED BAR ================= */}
      <div className="lg:hidden fixed top-0 left-0 right-0 z-[60] bg-black/95 backdrop-blur-xl border-b border-[#c9a84c]/20" style={{
      paddingTop: "var(--header-dynamic-padding, 44px)"
    }} dir="rtl">
      ...
      <div className="hidden lg:block relative z-10 bg-black/60 backdrop-blur-2xl border-t border-[#c9a84c]/10">
        <div dir="ltr" className="mx-auto max-w-7xl px-6 h-[44px] grid grid-cols-[auto_1fr_auto] items-center">
          ...
          <nav dir="rtl" className="flex justify-center items-center gap-10 text-[15px] font-semibold">
            ...
            <Link to="/stone-veneer" className="group relative inline-flex items-center gap-3 py-2 px-5 bg-white/10 backdrop-blur-md border border-white/20 text-white rounded-full shadow-lg hover:bg-white/20 hover:shadow-xl transition-all duration-500 hover:scale-105 transform -rotate-1 hover:rotate-0 font-medium overflow-hidden">
      ...
      {mobileOpen && <>
          {/* Backdrop with blur */}
          <div className="fixed inset-0 z-[59] lg:hidden bg-black/70 backdrop-blur-sm animate-fade-in" onClick={() => setMobileOpen(false)} aria-label="סגור תפריט" />

          {/* Drawer Panel */}
          <div className="fixed inset-y-0 right-0 z-[60] lg:hidden w-[85%] max-w-[360px]
             bg-gradient-to-bl from-[#0d0d0d] via-[#0a0a0a] to-black
        ...
        paddingBottom: "env(safe-area-inset-bottom)"
            ...
            <div className="flex items-center justify-between px-6 py-5 border-b border-[#c9a84c]/20">
              ...
              <button type="button" onClick={() => setMobileOpen(false)} className="flex items-center justify-center w-10 h-10 rounded-full bg-white/5 border border-[#c9a84c]/20 text-[#c9a84c] hover:bg-[#c9a84c]/10 hover:border-[#c9a84c]/40 transition-all duration-300">
            ...
            <nav className="px-6 py-6 space-y-1 overflow-y-auto max-h-[calc(100vh-180px)]">
              ...
              <Link to="/" onClick={() => setMobileOpen(false)} className="group flex items-center gap-3 py-3 px-4 rounded-xl hover:bg-[#c9a84c]/10 transition-all duration-300 animate-fade-in" style={{
            animationDelay: "50ms"
          }}>
                ...
                <span className={`text-[17px] font-semibold ${goldText} group-hover:translate-x-[-4px] transition-transform duration-300`}>
                  עמוד ראשי
                </span>
              </Link>

              <Link to="/about" onClick={() => setMobileOpen(false)} className="group flex items-center gap-3 py-3 px-4 rounded-xl hover:bg-[#c9a84c]/10 transition-all duration-300 animate-fade-in" style={{
            ...
            animationDelay: "150ms"
                ...
                <button type="button" onClick={() => setServicesOpen(v => !v)} className={`group w-full flex items-center justify-between py-3 px-4 rounded-xl hover:bg-[#c9a84c]/10 transition-all duration-300 ${servicesOpen ? "bg-[#c9a84c]/10" : ""}`}>
                  <div className="flex items-center gap-3">
                    <span className="flex items-center justify-center w-8 h-8 rounded-lg bg-gradient-to-br from-[#c9a84c]/20 to-transparent border border-[#c9a84c]/20 group-hover:border-[#c9a84c]/40 transition-colors">
                      <svg className="w-4 h-4 text-[#c9a84c]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <svg className={`w-4 h-4 text-[#c9a84c] transition-transform duration-300 ${servicesOpen ? "rotate-180" : ""}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div className={`overflow-hidden transition-all duration-300 ease-out ${servicesOpen ? "max-h-[500px] opacity-100" : "max-h-0 opacity-0"}`}>
                  <div className="mr-6 pr-4 py-2 border-r-2 border-[#c9a84c]/30 space-y-1">
                    {serviceLinks.map((item, index) => <Link key={item.path} to={item.path} onClick={() => setMobileOpen(false)} className="group flex items-center gap-2 py-2.5 px-3 rounded-lg text-[15px] text-[#d6c38a] hover:text-[#e8d5a3] hover:bg-[#c9a84c]/10 transition-all duration-200" style={{
              ...
              <Link to="/projects" onClick={() => setMobileOpen(false)} className="group flex items-center gap-3 py-3 px-4 rounded-xl hover:bg-[#c9a84c]/10 transition-all duration-300 animate-fade-in" style={{
            animationDelay: "200ms"
              ...
              <Link to="/pricing" onClick={() => setMobileOpen(false)} className="group flex items-center gap-3 py-3 px-4 rounded-xl hover:bg-[#c9a84c]/10 transition-all duration-300 animate-fade-in" style={{
            animationDelay: "250ms"
              ...
              <Link to="/contact" onClick={() => setMobileOpen(false)} className="group flex items-center gap-3 py-3 px-4 rounded-xl hover:bg-[#c9a84c]/10 transition-all duration-300 animate-fade-in" style={{
            ...
            <div className="absolute bottom-0 left-0 right-0 p-6 border-t border-[#c9a84c]/20 bg-gradient-to-t from-[#0a0a0a] to-transparent">
              <Link to="/contact" onClick={() => setMobileOpen(false)} className="quote-shimmer flex items-center justify-center gap-2 h-14 w-full rounded-2xl bg-gradient-to-r from-[#e8d5a3] via-[#c9a84c] to-[#b8943f] text-black font-bold text-lg shadow-lg shadow-[#c9a84c]/20 hover:shadow-xl hover:shadow-[#c9a84c]/30 hover:scale-[0.98] active:scale-95 transition-all duration-300 animate-fade-in" style={{
