...
const Footer = () => {
  ...
  return (
    <footer className="bg-hero-dark text-white sticky bottom-0 z-20" dir={dir}>
      {/* Top Contact Strip */}
      ...
      <div className="py-12">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
            ...
            {/* Center Logo */}
            <div
              className={`flex flex-col items-center gap-4 ${dir === "rtl" ? "order-1 lg:order-2" : "order-2 lg:order-2"}`}
            >
