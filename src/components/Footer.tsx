  ...
  <footer className="bg-[#d2d4d6] dark:bg-hero-dark text-black dark:text-white transition-colors duration-300" dir={dir}>
      ...
      <div className="border-b border-primary/10 py-6">
        <div className="container mx-auto px-4">
          <div className={`grid grid-cols-1 md:grid-cols-3 gap-6 text-center ${dir === 'rtl' ? 'md:text-right' : 'md:text-left'}`}>
    ...
    {t("footer.projects")}
            ...
            <div className={`flex flex-col items-center gap-4 ${dir === 'rtl' ? 'order-1 lg:order-2' : 'order-2 lg:order-2'}`}>
              <Link to="/" aria-label="א.א פרויקטים וגובה">
                <img src={logoImage} alt="א.א פרויקטים וגובה" className="h-[80px] w-auto object-contain" draggable={false} />
              </Link>
              ...
              <div className="flex gap-4 mt-2">
                <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-primary transition-colors" aria-label="LinkedIn">
                  <Linkedin size={20} />
                </a>
                <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-primary transition-colors" aria-label="Facebook">
                  <Facebook size={20} />
                </a>
                <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-primary transition-colors" aria-label="Instagram">
                  <Instagram size={20} />
                </a>
              </div>
            </div>
            ...
            <nav className={`flex flex-col gap-3 ${dir === 'rtl' ? 'order-2 lg:order-3' : 'order-3 lg:order-3'}`}>
              ...
              <Link to="/pricing" className={`text-white/80 hover:text-primary transition-colors ${dir === 'rtl' ? 'text-right' : 'text-left'}`}>
                {t("footer.pricing")}
              </Link>
              <Link to="/testimonials" className={`text-white/80 hover:text-primary transition-colors ${dir === 'rtl' ? 'text-right' : 'text-left'}`}>
                {t("footer.testimonials")}
              </Link>
              <Link to="/contact" className={`text-white/80 hover:text-primary transition-colors ${dir === 'rtl' ? 'text-right' : 'text-left'}`}>
                {t("footer.contact")}
              </Link>
              <Link to="/accessibility" className={`text-white/80 hover:text-primary transition-colors ${dir === 'rtl' ? 'text-right' : 'text-left'}`}>
                הצהרת נגישות
              </Link>
            </nav>
          </div>
